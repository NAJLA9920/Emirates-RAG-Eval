...
async def lifespan(app: FastAPI):
    ...
    GENERATIVE_MODELS['falcon-7b-instruct'] = ReplicateReg(model="falcon-7b-instruct", api_token=REPLICATE_API_TOKEN)
    GENERATIVE_MODELS['llama-2-7b-instruct'] = ReplicateReg(model="llama-2-7b-instruct", api_token=REPLICATE_API_TOKEN)
